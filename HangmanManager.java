//Your constructor is passed a dictionary of words, a target word length,
//and the maximum number of wrong guesses the player is allowed to
//make. It should use these values to initialize the state of the game.
//The set of words should initially contain all words from the dictionary
//of the given length, eliminating any duplicates. It should throw an
//IllegalArgumentException if length is less than 1 or if max is less than
//0.
import java.util.*;
